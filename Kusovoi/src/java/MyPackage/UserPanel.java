...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet UserPanel</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet UserPanel at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
         ...
         switch(request.getParameter("item"))
        {
            ...
            phoneDAO.addPhoneDetails(description, number,mobNumber );
